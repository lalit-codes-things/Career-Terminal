    ...
    return JSON.stringify({
      fields: [
        ...
        },
        {
          ...
          value: 'Interview likelihood is 82% and offer probability is 55% — this is a strong lead worth prioritizing.',
          confidence: 0.82,
          evidence: [{ excerpt: 'AI decision predictions: interview 82%, offer 55%.' }],
        },
        {
          field: 'Communication Tip',
          value: 'Use direct, concise language. Ada Recruiter communicates with urgency and expects prompt, action-oriented responses.',
          confidence: 0.85,
          evidence: [{ excerpt: 'Behavioral profile: direct communication style, high urgency.' }],
        },
      ],
    });
  }
