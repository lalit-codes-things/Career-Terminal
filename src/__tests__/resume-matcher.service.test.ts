...
describe('ResumeMatcherService', () => {
  ...
  it('should parse resume text correctly', async () => {
    const resumeText =
      'I am a senior developer with experience in React, JavaScript, and Node.js. I know AWS and Docker too. B.S. Computer Science.';
  ...
  it('should calculate match score correctly', async () => {
    const resumeText =
      'I am a senior developer with experience in React, JavaScript, and Node.js. I know AWS and Docker too.';
    const jobText =
      'Looking for a senior developer who knows JavaScript, TypeScript, React, AWS, Docker, CI/CD.';
